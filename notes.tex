...
The main goal is to parallelize the graph compute over multiple devices

\subsection{Parallelization Problems}
Problems to solve:
\begin{itemize}
    \item How to partition?
    \item How to communicate?
    \item How to schedule?
    \item Consistency
    \item How to auto-parallelize?
\end{itemize}

\subsection{Runtime \& Scheduling}
The goal is to compute/communication/memory in a way that:
\begin{itemize}
    \item as fast as possible
    \item overlaps communication with compute
    \item subject to memory constraints
\end{itemize}

\subsection{Operator Implementation}
The goal is to get the fastest implementation of:
\begin{itemize}
    \item MatMul
    \item Conv2d
\end{itemize}
for different:
\begin{itemize}
    \item hardware: V100, A100, H100, phone, TPU
    \item precision: fp32, fp16, fp8, fp4
    \item shapes: conv2d\_3x3, conv2d\_5x5, matmul2D, 3D, attention
\end{itemize}
